...
Feature: Bulk duplicate activity visibility in mimo format
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | page     | Page 1  | Intro 1  | TC1    | 1       |
      | page     | Page 2  | Intro 2  | TC1    | 1       |
      | page     | Page 3  | Intro 3  | TC1    | 1       |
      | page     | Page 4  | Intro 4  | TC1    | 1       |
      | page     | Page 5  | Intro 5  | TC1    | 1       |
      | page     | Page 6  | Intro 6  | TC1    | 1       |
      | page     | Page 7  | Intro 7  | TC1    | 1       |
      | page     | Page 8  | Intro 8  | TC1    | 1       |
      | page     | Page 9  | Intro 9  | TC1    | 1       |
      | page     | Page 10 | Intro 10 | TC1    | 1       |
      | page     | Page 11 | Intro 11 | TC1    | 1       |
      | page     | Page 12 | Intro 12 | TC1    | 1       |
      | page     | Page 13 | Intro 13 | TC1    | 1       |
      | page     | Page 14 | Intro 14 | TC1    | 1       |
      | page     | Page 15 | Intro 15 | TC1    | 1       |
      | page     | Page 16 | Intro 16 | TC1    | 1       |
      | page     | Page 17 | Intro 17 | TC1    | 1       |
      | page     | Page 18 | Intro 18 | TC1    | 1       |
      | page     | Page 19 | Intro 19 | TC1    | 1       |
      | page     | Page 20 | Intro 20 | TC1    | 1       |

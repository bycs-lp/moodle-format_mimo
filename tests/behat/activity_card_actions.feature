...
Feature: Activity card action controls in mimo format
  ...
  Scenario: Settings icon is visible on activity cards in editing mode
    ...
    Then ".mimo-card-controls .mimo-icon-btn .fa-cog" "css_element" should exist
  ...
  Scenario: Delete icon is visible on activity cards in editing mode
    ...
    When I am on "Test Course 1" course homepage with editing mode on
    And I wait until ".mimo-card" "css_element" exists
    Then ".mimo-card-controls [data-action='cmDelete'] .fa-trash" "css_element" should exist
  ...
  Scenario: Settings icon links to activity settings page
    ...
    And I wait until ".mimo-card" "css_element" exists
    When I click on ".mimo-icon-btn .fa-cog" "css_element" in the "Page 1" "activity"
  ...
  Scenario: Card action icons are not visible for students
    ...
    And I wait until ".mimo-card" "css_element" exists
    Then ".mimo-card-controls" "css_element" should not exist
  ...
  Scenario: Card action icons are not visible when editing mode is off
    ...
    When I am on "Test Course 1" course homepage
    And I wait until ".mimo-card" "css_element" exists
    Then ".mimo-card-controls .mimo-icon-btn .fa-cog" "css_element" should not exist
    And ".mimo-card-controls [data-action='cmDelete']" "css_element" should not exist

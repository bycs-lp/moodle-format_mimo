...
Feature: Activity pagination in mimo format
  ...
  Scenario: Pagination controls appear when there are more than 8 activities
    ...
    And I wait until ".mimo-navigation.is-visible" "css_element" exists
    Then ".mimo-navigation.is-visible" "css_element" should exist
    And "button#mimo-prev" "css_element" should exist
    And "button#mimo-next" "css_element" should exist
  ...
  Scenario: Student can navigate between pages
    ...
    And I wait until "button#mimo-next:not([disabled])" "css_element" exists
    When I click on "button#mimo-next" "css_element"
    And I wait until ".mimo-activities .col-12:not([style*='display: none'])" "css_element" exists
    Then I should see "Page 9"
    And I should see "Page 10"
    And I should not see "Page 2" in the ".mimo-activities" "css_element"
  ...
  Scenario: Previous button works correctly
    ...
    And I wait until ".mimo-navigation.is-visible" "css_element" exists
    And I wait until "button#mimo-next:not([disabled])" "css_element" exists
    And I click on "button#mimo-next" "css_element"
    And I wait until ".mimo-activities .col-12:not([style*='display: none'])" "css_element" exists
    Then I should see "Page 9"
    And I wait until "button#mimo-prev:not([disabled])" "css_element" exists
    When I click on "button#mimo-prev" "css_element"
    And I wait until ".mimo-activities .col-12:not([style*='display: none'])" "css_element" exists
    Then I should see "Page 1"
    And I should see "Page 8"
    And I should not see "Page 9" in the ".mimo-activities" "css_element"

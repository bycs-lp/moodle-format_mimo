...
Feature: Pagination edge cases in minimoodlewall format
  ...
  Scenario: Pagination works with filtering
    Given the following "format_minimoodlewall > activities" exist:
      ...
      | page     | Reading 1  | First   | TC1    | 0       | Reading  |
      | page     | Reading 2  | Second  | TC1    | 0       | Reading  |
      | page     | Reading 3  | Third   | TC1    | 0       | Reading  |
      | page     | Reading 4  | Fourth  | TC1    | 0       | Reading  |
      | page     | Reading 5  | Fifth   | TC1    | 0       | Reading  |
      | assign   | Practice 1 | Sixth   | TC1    | 0       | Practice |
      | assign   | Practice 2 | Seventh | TC1    | 0       | Practice |
      | assign   | Practice 3 | Eighth  | TC1    | 0       | Practice |
      | assign   | Practice 4 | Ninth   | TC1    | 0       | Practice |
      | assign   | Practice 5 | Tenth   | TC1    | 0       | Practice |

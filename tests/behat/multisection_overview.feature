...
Feature: Multi-section overview in minimoodlewall format
  ...
  Background:
    ...
    And the following "format_minimoodlewall > courses" exist:
      ...
      | Test Course 1 | TC1       | minimoodlewall | 1                  | 3           |
  ...
  Scenario: Overview grid shows section cards
    ...
    Then ".mmw-overview-grid" "css_element" should exist
    And I should see "Section 1" in the ".mmw-overview-grid" "css_element"
    And I should see "Section 2" in the ".mmw-overview-grid" "css_element"
    And I should see "Section 3" in the ".mmw-overview-grid" "css_element"

  Scenario: Section card links to wall view
    Given I log in as "student1"
    And I am on "Test Course 1" course homepage
    When I click on "Section 1" "link" in the ".mmw-overview-grid" "css_element"
    Then I should see "Page 1"
    And I should see "Assignment 1"
    And ".mmw-overview-grid" "css_element" should not exist

  Scenario: Back to overview button returns to overview
    Given I log in as "student1"
    And I am on "Test Course 1" course homepage
    And I click on "Section 1" "link" in the ".mmw-overview-grid" "css_element"
    And I should see "Page 1"
    When I click on ".mmw-overview-btn" "css_element"
    Then ".mmw-overview-grid" "css_element" should exist
    And I should see "Section 1" in the ".mmw-overview-grid" "css_element"
  ...
  Scenario: Sticky wall remembers last visited section
    Given I log in as "student1"
    And I am on "Test Course 1" course homepage
    And I click on "Section 2" "link" in the ".mmw-overview-grid" "css_element"
  ...
  Scenario: Teacher can delete a section
    ...
    And I should see "Section 3" in the ".mmw-overview-grid" "css_element"
    When I click on "[data-action='delete-section']" "css_element" in the ".mmw-overview-card[data-section-num='3']" "css_element"
    And I click on "Delete section" "button" in the ".modal" "css_element"
    And I wait until ".mmw-overview-card[data-section-num='3']" "css_element" does not exist
    Then I should not see "Section 3" in the ".mmw-overview-grid" "css_element"

  Scenario: Section cards are draggable in editing mode
    Given I log in as "teacher1"
    When I am on "Test Course 1" course homepage with editing mode on
    And I wait until "[data-for='mmw-overview-card']" "css_element" exists
    Then "[data-for='mmw-overview-card'][draggable='true']" "css_element" should exist

  Scenario: Section cards are not draggable for students
    Given I log in as "student1"
    When I am on "Test Course 1" course homepage
    Then "[data-for='mmw-overview-card'][draggable='true']" "css_element" should not exist

  Scenario: Mini-tiles appear on cards with activities
    Given I log in as "student1"
    When I am on "Test Course 1" course homepage
    Then ".mmw-overview-card__miniwall" "css_element" should exist in the ".mmw-overview-card[data-section-num='1']" "css_element"
    And ".mmw-overview-card__minitile" "css_element" should exist in the ".mmw-overview-card[data-section-num='1']" "css_element"

  Scenario: Empty section has no mini-tiles
    Given I log in as "student1"
    When I am on "Test Course 1" course homepage
    Then ".mmw-overview-card__miniwall" "css_element" should not exist in the ".mmw-overview-card[data-section-num='3']" "css_element"

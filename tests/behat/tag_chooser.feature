...
Feature: Tag-based activity chooser in mimo format
  ...
  Scenario: Teacher sees tag dropdown when adding activity
    ...
    And I wait until ".format-mimo-tagchooser .dropdown-menu.show" "css_element" exists
    Then "[data-tag-name='Reading']" "css_element" should exist in the ".format-mimo-tagchooser .dropdown-menu" "css_element"
    And "[data-tag-name='Practice']" "css_element" should exist in the ".format-mimo-tagchooser .dropdown-menu" "css_element"
    And "[data-tag-name='Discuss']" "css_element" should exist in the ".format-mimo-tagchooser .dropdown-menu" "css_element"
  ...
  Scenario: Teacher can create activity with pre-selected tag and activity type
    ...
    When I click on "button[data-action='open-tagchooser']" "css_element"
    And I wait until ".format-mimo-tagchooser .dropdown-menu.show" "css_element" exists
    And I click on "[data-tag-name='Reading']" "css_element" in the ".format-mimo-tagchooser .dropdown-menu" "css_element"
  ...
  Scenario: Activity is automatically tagged after creation
    ...
    When I click on "button[data-action='open-tagchooser']" "css_element"
    And I wait until ".format-mimo-tagchooser .dropdown-menu.show" "css_element" exists
    And I click on "[data-tag-name='Practice']" "css_element" in the ".format-mimo-tagchooser .dropdown-menu" "css_element"
    And I wait until ".modal-dialog" "css_element" exists

...
Feature: Activity type descriptions with tags
  ...
  Scenario: Admin can manage activity descriptions with description tags
    ...
    When I visit "/course/format/mimo/description_tags.php"
    ...
    When I visit "/course/format/mimo/activity_descriptions.php"
  ...
  Scenario: Teacher sees description tag pill on activity cards in chooser modal
    Given the following "format_mimo > description tags" exist:
      | name     | color   |
      | Homework | #ff6b6b |
      | Classwork| #4ecdc4 |
    And the following "format_mimo > activity descriptions" exist:

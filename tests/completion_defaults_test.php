...
final class completion_defaults_test extends \advanced_testcase {
    ...
    public function test_apply_defaults_invalid_json_custom_rules(): void {
        ...
        // Create a mimo override with deliberately broken JSON.
        $mimodefaults = (object) [
            'module' => $assignid,
            'completion' => COMPLETION_TRACKING_AUTOMATIC,
            'completionview' => 0,
        ...
        // Create an assign activity first.
        ...
        // Call apply_defaults directly with broken JSON.
        completion_defaults_manager::apply_defaults($cm, $mimodefaults, 'assign');
    ...
    /**
     * apply_defaults() correctly applies custom rules to the module instance table.
     */
    public function test_apply_defaults_sets_module_custom_rules(): void {
        global $DB;

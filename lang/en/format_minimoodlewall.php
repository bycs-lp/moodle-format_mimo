...
$string['confirmdeletetagset'] = 'Are you sure you want to delete the tag set "{$a}" and all its tags?';
$string['createdesctag'] = 'Create Description Tag';
$string['createtag'] = 'Create Tag';
$string['createtagset'] = 'Create Tag Set';
$string['currentsection'] = 'This section';
$string['defaulttagset'] = 'Default Tags';
$string['defaulttagset_desc'] = 'Default set of activity tags';
$string['deletetag'] = 'Delete Tag';
$string['deletetagset'] = 'Delete Tag Set';
...
$string['notag'] = 'No tag';
$string['notags'] = 'No tags in this tag set.';
$string['notagsets'] = 'No tag sets have been created yet.';
...
$string['setting_tagmanagement_link'] = 'Manage tags and tag sets';
$string['setting_tagsetid'] = 'Tag set';
$string['setting_tagsetid_help'] = 'Select which tag set to use for this course. This cannot be changed after course creation.';
...
$string['tags'] = 'Tags';
$string['tagsetdescription'] = 'Tag Set Description';
$string['tagsetname'] = 'Tag Set Name';
$string['tagsets'] = 'Tag Sets';
$string['theme'] = 'Theme';

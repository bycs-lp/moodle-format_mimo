...
$string['filterimage'] = 'Filter Bar Image';
$string['filterimage_help'] = 'Upload the small SVG that will be shown inside the filter bar. If no image is provided, the tag name will be displayed as text instead.';

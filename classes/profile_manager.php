...
class profile_manager {
    ...
    public function initialize_default_profiles(): void {
        ...
        $defaults = [
            ['name' => 'base_symbols',
                'displayname' => get_string('profile_base_symbols', 'format_mimo'), 'sortorder' => 1],
            ['name' => 'primary_horst',
                'displayname' => get_string('profile_primary_horst', 'format_mimo'), 'sortorder' => 2],
            ['name' => 'foreignlanguage_english',
                'displayname' => get_string('profile_foreignlanguage_english', 'format_mimo'), 'sortorder' => 3],
        ];
    ...
    private function get_default_profile_tag_overrides(): array {
        return [
            ...
            'foreignlanguage_english' => [
                0 => ['name' => get_string('tag_reading', 'format_mimo'),
                    'cardimage' => 'english_reading.png', 'filterimage' => 'english_reading.png'],
                1 => ['name' => get_string('tag_writing', 'format_mimo'),
                    'cardimage' => 'english_writing.png', 'filterimage' => 'english_writing.png'],
                2 => ['name' => get_string('tag_speak', 'format_mimo'),
                    'activitytype1' => 'assign', 'activitytype2' => 'forum',
                    'cardimage' => 'english_speak.png', 'filterimage' => 'english_speak.png'],
                3 => ['name' => get_string('tag_translate', 'format_mimo'),
                    'activitytype1' => 'assign', 'activitytype2' => 'page', 'activitytype3' => 'quiz',
                    'cardimage' => 'english_translate.png', 'filterimage' => 'english_translate.png'],
                4 => ['name' => get_string('tag_vocabulary', 'format_mimo'),
                    'activitytype1' => 'hvp', 'activitytype2' => 'wiki',
                    'cardimage' => 'english_vocabulary.png', 'filterimage' => 'english_vocabulary.png'],
                5 => ['name' => get_string('tag_grammar', 'format_mimo'),
                    'activitytype1' => 'page', 'activitytype2' => 'glossary',
                    'cardimage' => 'english_grammar.png', 'filterimage' => 'english_grammar.png'],
                6 => ['name' => get_string('tag_produce', 'format_mimo'),
                    'cardimage' => 'english_produce.png', 'filterimage' => 'english_produce.png'],
                7 => ['name' => get_string('tag_research', 'format_mimo'),
                    'cardimage' => 'english_research.png', 'filterimage' => 'english_research.png'],
                8 => ['name' => get_string('tag_hearing', 'format_mimo'),
                    'cardimage' => 'english_hearing.png', 'filterimage' => 'english_hearing.png'],
                9 => ['name' => get_string('tag_cooperate', 'format_mimo'),
                    'cardimage' => 'english_cooperate.png', 'filterimage' => 'english_cooperate.png'],
                10 => ['name' => get_string('tag_projectwork', 'format_mimo'),
                    'cardimage' => 'english_projectwork.png', 'filterimage' => 'english_projectwork.png'],
                11 => ['name' => get_string('tag_testyourself', 'format_mimo'),
                    'cardimage' => 'english_testyourself.png', 'filterimage' => 'english_testyourself.png'],
                12 => ['name' => get_string('tag_discuss', 'format_mimo'),
                    'cardimage' => 'english_discuss.png', 'filterimage' => 'english_discuss.png'],
                13 => ['name' => get_string('tag_reflect', 'format_mimo'),
                    'cardimage' => 'english_reflect.png', 'filterimage' => 'english_reflect.png'],
            ],
        ];
    }
